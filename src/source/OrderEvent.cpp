...
unsigned OrderEvent::ind_cur_status() { return _ind_cur_status; }
...
const char *OrderEvent::status() { return _all_status[_ind_cur_status]; }
...
OrderEvent::OrderEvent(int n)
    : _ind_cur_status(n), _size_all_status(COUNT_BLOCKS) {
